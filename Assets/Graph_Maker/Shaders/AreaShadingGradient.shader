...
/// Final Color:
                return fixed4(finalColor,lerp(tex2D(_Gradient,TRANSFORM_TEX(node_679, _Gradient)).rgb,float3(0,0,0),_Transparency).r);
            }
            ENDCG
        }
        Pass {
