...
namespace sharpPDF
{
	...
	public class pdfPage : IWritable
	{
		...
		public void newAddImage ( byte[] byteArray, int X, int Y, int sizeX, int sizeY )
		{
			addImage(byteArray, X, Y, sizeX, sizeY);
			Debug.Log("Adding Image Length " + byteArray.Length + " HEIGTH :" + sizeX + " WIDTH :" + sizeY);
		}
