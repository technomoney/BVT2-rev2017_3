...
#pragma warning restore 0649
        ...
        {
            //     List<string> headerTexts = new List<string>(new string[] { "Display Name", "Name" });
            //   List<string> properties = new List<string>(new string[] { "displayName", "name" });
        ...
        void clickHandler(object creationParams)
        {
            ...
            //element.FindPropertyRelative("displayName").stringValue = data.displayName;
