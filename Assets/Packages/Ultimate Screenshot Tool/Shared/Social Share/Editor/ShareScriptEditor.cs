...
namespace TRS.CaptureTool.Share
{
    ...
    public class ShareScriptEditor : Editor
    {
        ...
        void Awake()
        {
            ...
            hasGifComponent = ((ShareScript)target).gameObject.GetComponent(gifClass) != null;
        }
        ...
        public void FullShareUI()
        {
            ...
            EditorGUILayout.HelpBox("Config files are created in " + CreateCaptureToolConfig.CONFIG_FOLDER + " to avoid overwrites when tool is updated.", MessageType.Info);
        ...
        void SelectUrlSettings()
        {
            ...
            if (showSelectUrlSettings)
            {
                ...
                if (serializedObject.FindProperty("useCustomUrl").boolValue)
                {
                    ...
                    {
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("customUrl"), true);
                    ...
                    EditorGUILayout.HelpBox("Use this option to share a customized url. Specify values here or override the CustomCodeFunction delegate. (Keep your code in a separate file, so you can update the asset without losing it.)", MessageType.Info);
                }
                else
                {
        ...
        void Imgur()
        {
            ...
            if (((ShareScript)target).showSharedMethodSettings[(int)platform])
            {
                ...
                EditorGUILayout.HelpBox("Comma separated without the hashtags. (Ex. gaming,creativity)", MessageType.Info);
            }
        ...
        void Twitter()
        {
            ...
            if (((ShareScript)target).showSharedMethodSettings[(int)platform])
            {
                ...
                EditorGUILayout.HelpBox("Comma separated without the hashtags. (Ex. gamedev,indiedev,indiegames,madewithunity)", MessageType.Info);
