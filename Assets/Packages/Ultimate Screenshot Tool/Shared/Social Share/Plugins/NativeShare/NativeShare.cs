...
public class NativeShare
{
    ...
    // Tangled Reality Studios modified - 8/31/18 - added the url property and SetUrl method
    ...
    public void Share()
    {
        ...
        Debug.Log("Shared!");
#elif UNITY_ANDROID
		AJC.CallStatic( "Share", Context, targetPackage, targetClass, files.ToArray(), mimes.ToArray(), subject, text, title, url );
#elif UNITY_IOS
